...
public class Activity_Faq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_header.setText("FAQ");
        if (UtilClassForValidations.haveInternet(Activity_Faq.this)){
            dialog = new ACProgressFlower.Builder(Activity_Faq.this)
            ...
            Toast.makeText(Activity_Faq.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
    }

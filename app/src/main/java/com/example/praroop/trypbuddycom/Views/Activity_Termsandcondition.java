...
public class Activity_Termsandcondition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_header.setText("Terms & Condition");
        if (UtilClassForValidations.haveInternet(Activity_Termsandcondition.this)){
            dialog = new ACProgressFlower.Builder(Activity_Termsandcondition.this)
            ...
            Toast.makeText(Activity_Termsandcondition.this, "No Internet Connection", Toast.LENGTH_SHORT).show();
        }
    }
    class callToLoadAboutUs extends AsyncTask<String, Integer, CombineDataSetNew> {
        protected CombineDataSetNew doInBackground(String... arg0) {
            ...
            try {
                Response = WebService.termsandconditionLoad(
                );
                if (Response != null) {
                    try {

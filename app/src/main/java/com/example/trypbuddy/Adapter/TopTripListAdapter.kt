...
import com.example.trypbuddy.Model.TopTripListModel
 ...
 */
class TopTripListAdapter(val arrData: ArrayList<TopTripListModel.Data>?, var fragmentContext: Activity?, val tripClickListner: TripClickListner, val clickListnerBookMark: ClickListnerBookMark, val clickListnerWishList: ClickListnerWishList) : RecyclerView.Adapter<TopTripListAdapter.ViewHolder>(), Observer {

...
import com.example.trypbuddy.Model.TopCityModel
 ...
 */
class TopCityListAdapter(val arrData: ArrayList<TopCityModel.Data>?, var fragmentContext: Activity?, var categoryClick: CategoryClick) : RecyclerView.Adapter<TopCityListAdapter.ViewHolder>(), Observer {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder?.text_category!!.text = data.city_name

...
import com.example.trypbuddy.Model.AccessoriesCategoryModel
 ...
 */
class AccessoriesCategoryListAdapter(val arrData: ArrayList<AccessoriesCategoryModel.Data>?, var fragmentContext: Activity?, var categoryClick: CategoryClick) : RecyclerView.Adapter<AccessoriesCategoryListAdapter.ViewHolder>(), Observer {
